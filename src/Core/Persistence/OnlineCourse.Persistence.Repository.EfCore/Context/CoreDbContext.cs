...
using OnlineCourse.Persistence.Repository.EfCore.Extension;
using OnlineCourse.Persistence.Repository.EfCore.Mapping;
using Microsoft.EntityFrameworkCore;
using Microsoft.Extensions.Logging;

namespace OnlineCourse.Persistence.Repository.EfCore.Context
{
    public abstract class CoreDbContext : DbContext
    {
        ...
        {
            IEnumerable<Type> types = AppDomain.CurrentDomain.GetAssemblies().Where(p=>p.FullName.Contains("OnlineCourse")).SelectMany(asm => asm.DefinedTypes).Select(x => x.AsType());
